...
implicit in the "Provided Beginning of Solution".)  Actually, this
doesn't seem to be a hint after all.  Maybe it's a trick.

Still, this is a valid solution, and it can be used with the following
commands:

.  >>> from TwoSum_4 import Solution
.  >>> Solution.twoSum(Solution, [1,2,3,4,5], 8)
.  [2, 4]

.  >>> mysoln = Solution
.  >>> Solution.twoSum(mysoln, [1,2,3,4,5], 8)
.  [2, 4]

.  >>> help(Solution.twoSum)

.  >>> print(Solution.twoSum.__doc__)
